		...
		<div class="container">
			...
			<div class="pull-right">
				...
				<p>
						...
						<a href="#logout" onclick="user.authorization.logout({ page_return: '/' })">Выйти</a>
				</p>
				<?php else: ?>
						  <a class="btn btn-xs btn-primary" href='/user/login'>Войти</a>
				<?php endif; ?>
			</div>
			<h5><?php foreach ($breadcrumbs as $key=>$item): ?><a href='<?php echo $item; ?>'><?php echo $key; ?></a> -> <?php endforeach; ?><?php echo $title; ?></h5>
		</div>
	</div>
