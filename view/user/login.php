          ...
          <div class="form-question">
            ...
            <div class="form-question">
               <div class="item">
                    ...
                    <input id="loginusername" name="text" value="" class="form-control" aria-label="e-mail" aria-required="true" title="">
            ...
            <div class="form-question">
               <div class="item">
                    ...
                    <input id="loginpass" type="password" name="" value="" class="form-control"  aria-label="пароль" aria-required="true" title="">
                    <div class="error-message"></div>
       						</div>
               </div>
            </div>
