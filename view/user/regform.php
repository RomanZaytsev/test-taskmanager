<div class="container content-container">
   ...
   <div id="content-body" class="content">
      <form action="/api/user/regform" method="POST" id="form" onsubmit="">
            ...
            <div class="form-question">
               <div class="item">
                  <div class="form-entry">
                     ...
                     <input id="regformname" type="text" name="mynameis" value="" class="q-short" aria-label="Ваше имя" aria-required="true" title="">
            ...
            <div class="form-question">
               <div class="item">
                  <div class="form-entry">
                     ...
                     <input id="regformemail" type="text" name="email" value="" class="q-short" aria-label="e-mail" aria-required="true" title="">
                     <div class="error-message"></div>
                  </div>
               </div>
            </div>
            <div class="form-question">
               <div class="item">
                  <div class="form-entry">
                     ...
                     <input id="regformpass" type="text" name="passwd" value="" class="q-short"  aria-label="пароль" aria-required="true" title="">
                     <div class="error-message"></div>
                  </div>
               </div>
            </div>
...
<script type="text/javascript">
		...
		user.account.create({
			...
			success: function(data) {
				user.authorization.login({
					page_return: '{$switch_section}{$this_section.path[count($this_section.path)-1].id}',
					data: {
						account_id: data.id,
						email: email,
						hash: hash.toString()
	...
	document.getElementById('regformpass').onkeydown = function() {
		if (event.keyCode == 13) { submit(); return false; }
	};
</script>
